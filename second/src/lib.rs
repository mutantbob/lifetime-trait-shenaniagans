...
impl<'a> IndexSettings<&'a mut H266MergersPadSettings> for &'a mut [H266MergersPadSettings] {
    fn settings_at(&mut self, idx: usize) -> Option<&'a mut H266MergersPadSettings> {
        Some(&mut self[idx])
    }
...
impl IndexSettings<MutexGuard<'_, H266MergersPadSettings>> for Vec<H266MergersPad> {
...
pub fn foo<T: DerefMut<Target = H266MergersPadSettings>>(mut pads: impl IndexSettings<T>) {
